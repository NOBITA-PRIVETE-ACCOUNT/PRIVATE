...
from NOBITAMUSIC.utils import NOBITAbin
MU = "CHIN_TAPAK_DAM_DAM_xBOT" #Dont change it seever connecter
from NOBITAMUSIC.utils.database import get_assistant, get_lang
import asyncio
...
import config
load_dotenv()
from NOBITAMUSIC.logging import LOGGER
