...
from NOBITAMUSIC import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from NOBITAMUSIC.core.call import NOBITA
from NOBITAMUSIC.utils import seconds_to_min, time_to_seconds
from NOBITAMUSIC.utils.channelplay import get_channeplayCB
from NOBITAMUSIC.utils.database import add_served_chat, get_assistant, is_video_allowed
from NOBITAMUSIC.utils.decorators.language import languageCB
from NOBITAMUSIC.utils.decorators.play import PlayWrapper
from NOBITAMUSIC.utils.formatters import formats
from NOBITAMUSIC.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from NOBITAMUSIC.utils.inline.playlist import botplaylist_markup
from NOBITAMUSIC.utils.logger import play_logs
from NOBITAMUSIC.utils.stream.stream import stream
...
@app.on_callback_query(filters.regex("NOBITAPlaylists") & ~BANNED_USERS)
@languageCB
