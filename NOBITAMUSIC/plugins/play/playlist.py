...
from NOBITAMUSIC import Carbon, app
from NOBITAMUSIC.utils.decorators.language import language, languageCB
from NOBITAMUSIC.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from NOBITAMUSIC.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from NOBITAMUSIC import YouTube
...
@app.on_callback_query(filters.regex("nobita_playlist") & ~BANNED_USERS)
@languageCB
