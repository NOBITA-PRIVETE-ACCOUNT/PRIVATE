...
from NOBITAMUSIC.utils.database import get_authuser_names, get_cmode
from NOBITAMUSIC.utils.decorators import ActualAdminCB, AdminActual, language
from NOBITAMUSIC.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await NOBITA.stop_stream(message.chat.id)
    except:
        pass
