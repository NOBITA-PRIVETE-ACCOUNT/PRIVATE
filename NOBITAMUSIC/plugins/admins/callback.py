...
from NOBITAMUSIC.utils.formatters import seconds_to_min
from NOBITAMUSIC.utils.inline import (
    close_markup,
    panel_markup_1,
    panel_markup_2,
    panel_markup_3,
...
from NOBITAMUSIC.utils.inline.play import stream_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await CallbackQuery.answer()
        await NOBITA.st_stream(chat_id)
        ...
        await NOBITA.mute_stream(chat_id)
        ...
        await NOBITA.unmute_stream(chat_id)
        ...
        if command == "Skip":
            ...
            try:
                ...
                if not check:
                    ...
                    try:
                        return await NOBITA.st_stream(chat_id)
                    except:
                        return
            except:
                try:
