...
def playlist_markupp(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"NOBITAPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            InlineKeyboardButton(
                text=_["P_B_2"],
                callback_data=f"NOBITAPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [
            InlineKeyboardButton(
...
def stream_markup(_, videoid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="✚ ᴘʟᴀʏʟɪsᴛ", callback_data=f"nobita_playlist {videoid}"
            ),
            InlineKeyboardButton(
                text="ᴄᴏɴᴛʀᴏʟs ♻",
...
def panel_markup_clone(_, vidid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="✚ ᴘʟᴀʏʟɪsᴛ ✚", callback_data=f"nobita_playlist {vidid}"
            ),
        ],
    ]
